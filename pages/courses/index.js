            ...
            <div className="mx-auto mt-4 grid w-full max-w-[1440px] grid-cols-1 gap-8 px-2 md:w-5/6 md:grid-cols-2">
                {courses.map((course) => (
                    <div className="grid grid-cols-12 gap-4" key={course.id}>
                        <div className="aniBtn col-span-12 lg:col-span-6 rounded-xl">
                        ...
                        <div className="col-span-12 lg:col-span-6 flex flex-col items-start justify-between space-y-2">
                            <div className="flex flex-col items-start justify-start">
                                ...
                                <h2 className="font-base text-sm lg:line-clamp-3 hover:underline">
                                    {course.description}
                                </h2>
                            </div>
                            <Button
                                ...
                                className="w-full aniBtn rounded-md bg-secondary px-4 py-2 font-bold text-primary"
                            >
                                Purchase
                            </Button>
                        </div>
